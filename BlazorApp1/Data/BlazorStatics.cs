...
{
    public class BlazorStatics
    {
        private static string path;
        public static void Init(string pth)
        {
            path = pth;
            XElement ontology = XElement.Load(path + "ontology_iis-v12-doc_ruen.xml");
            LoadOntNamesFromOntology(ontology);
            LoadInvOntNamesFromOntology(ontology);
        }
        
        public static Dictionary<string, string> OntNames { get; set; }
        public static Dictionary<string, string> InvOntNames { get; set; }
