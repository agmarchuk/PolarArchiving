...
namespace SoranCore3.Models
{
    internal class PhotosFirst : IComparer<XElement>
    {
        public int Compare(XElement x, XElement y)
        {
            ...
            string s1 = IndexModel.GetField(x, "http://fogid.net/o/from-date");
            string s2 = IndexModel.GetField(y, "http://fogid.net/o/from-date");
    ...
    public class IndexModel
    {
        ...
        public void BuildPortrait()
        {
            ...
            firstfaces = inorg_participation
                .Where(r => GetField(r, "http://fogid.net/o/role-classification") == "director")
                .ToArray();
            ...
            incollectionmember = this.XRecord.Elements("inverse")
                ...
                .Where(r => r != null)
                .OrderBy(r => GetField(r, "http://fogid.net/o/name"))
                .ToArray();
        ...
        public OAData.IFactographDataService data;
        public OAData.IOntologyService ontology;
        // Конструктор иногда вычисляет
        public IndexModel(OAData.IFactographDataService data, OAData.IOntologyService ontology)
        {
            this.data = data;
